#
# spec file for package icinga-plugin-check_linux_route
#

Name:           icinga-plugin-check_linux_route
Version:        %{version}
Release:        %{release}
...
cp check_linux_route "$RPM_BUILD_ROOT/usr/lib64/nagios/plugins/"

%files
%defattr(-,root,root,755)
%attr(0755,root,root) /usr/lib64/nagios/plugins/check_linux_route
